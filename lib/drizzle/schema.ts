import { pgTable, uuid, varchar, foreignKey, timestamp, text, json, boolean, index, vector, primaryKey } from "drizzle-orm/pg-core"
...
(table) => {
	return {
		...
		embeddingsResourceIdResourcesIdFk: foreignKey({
